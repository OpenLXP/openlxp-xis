...
class Command(TestCase):
    ...
    metadata_ledger = MetadataLedger(unique_record_identifier=
                                     'fe16decc-a982-40b2-bd2b-e8ab98b80a6f',
                                     metadata=meta_value,
                                     metadata_hash=
    ...
    composite_ledger = CompositeLedger(unique_record_identifier=
                                       'fe16decc-a982-40b2-bd2b-e8ab98b80a6f',
                                       metadata=meta_value,
                                       metadata_key_hash=
                                       '52c6a7eacac672e03e6a8c60c5fa39c2',
    ...
    def test_put_metadata_ledger_into_composite_ledger(self):
        ...
        self.assertEquals('DAU_oper_24_a02_bs_enus',
                          result_query_composite_ledger.get('metadata_key'))
        self.assertEquals('52c6a7eacac672e03e6a8c60c5fa39c2',
                          result_query_composite_ledger.get(
                              'metadata_key_hash'))
        self.assertEquals('205b2df155a2dd4783087af1ad07bca8',
    ...
    def test_check_metadata_ledger_transmission_ready_record_one_record(self,
                            mock_put_metadata_ledger_into_composite_ledger):
    ...
    def test_post_data_to_xse_created(self):
        ...
        with patch('elasticsearch.Elasticsearch.index') as response_obj:
            ...
            result_query = CompositeLedger.objects.values(
                ...
                metadata_key_hash='52c6a7eacac672e03e6a8c60c5fa39c2').first()
